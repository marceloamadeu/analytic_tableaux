...
yystate(21, [10|Ics], Line, Tlen, _, _) ->
    yystate(21, Ics, Line+1, Tlen+1, 9, Tlen);
...
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 66, C =< 72 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 74, C =< 77 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 80, C =< 90 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(19, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,19};
yystate(18, [83|Ics], Line, Tlen, _, _) ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 82 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 84, C =< 90 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(13, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line};
yystate(12, [80|Ics], Line, Tlen, _, _) ->
    yystate(16, Ics, Line, Tlen+1, 0, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 79 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 81, C =< 90 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 83 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 85, C =< 90 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
